        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start lg:items-stretch max-w-6xl mx-auto">
          ...
          <div className="animate-fade-in h-full flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="space-y-8 sm:space-y-10">
              ...
              <div>
                ...
                <Input id="telefone" inputMode="tel" autoComplete="tel" value={formData.telefone} onChange={handlePhoneChange} placeholder="(11) 95190-3402" maxLength={16} required />
              </div>
              ...
              <div>
                ...
                <Select value={formData.interesse} onValueChange={value => setFormData({
                ...formData,
                interesse: value
              })} required>
                  <SelectTrigger>
          ...
          animationDelay: "0.2s"
            ...
            <div className="space-y-4">
              {infoItems.map((item, index) => <div key={index} className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center flex-shrink-0">
                    <item.icon className="w-5 h-5 text-primary" />
                  </div>
                  <div>
                    <p className="font-semibold text-foreground mb-1">{item.title}</p>
                    {item.link ? <a href={item.link} target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-smooth">
                        {item.content}

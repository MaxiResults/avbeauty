    ...
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
      ...
      <div className="relative">
        <button
          ...
          className="w-14 h-14 rounded-full bg-blue-500 hover:bg-blue-600 shadow-lg flex items-center justify-center transition-smooth animate-pulse-soft cursor-not-allowed opacity-70"
      ...
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20BD5A] shadow-lg flex items-center justify-center transition-smooth animate-pulse-soft group"

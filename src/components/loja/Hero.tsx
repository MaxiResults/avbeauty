...
import andreiaVanessa from '@/assets/andreia-hero-new.jpg';
export function Hero() {
  ...
  return <section className="relative bg-gradient-to-br from-[#fdfdfd] via-[#ececec] to-[#9b9b9b] py-20 lg:py-32 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          {/* Foto da Andreia */}
          <div className="w-full lg:w-2/5 flex justify-center lg:justify-start">
            <div className="relative">
              <img src={andreiaVanessa} alt="Andreia Vanessa - AV Beauty" className="w-80 h-[480px] object-cover rounded-3xl shadow-2xl border-4 border-[#64473b]" />
            </div>
          </div>
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left space-y-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#181818] leading-tight font-display lg:text-5xl">Tratamentos Estéticos Profissionais</h1>
            ...
            <div className="bg-gradient-to-r from-[#624537] via-[#997564] to-[#624537] text-[#fdfdfd] inline-block px-6 py-3 rounded-lg">
              <p className="text-2xl md:text-3xl font-bold font-subtitle">
                Sobrancelhas, lábios e procedimentos faciais de alta qualidade
              </p>
            </div>

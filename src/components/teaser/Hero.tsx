  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-8">
        ...
        >
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-[#FFD700] shadow-[0_0_40px_rgba(255,215,0,0.4)]">
            <img 
              src={avBeautyHero} 
              alt="AV Beauty" 
        ...
        <motion.div
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 1 }}
          className="inline-flex flex-col items-center gap-2 px-8 py-4 rounded-full border-2 border-[#FFD700]"
          style={{

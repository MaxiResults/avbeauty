      ...
      <Card className="w-full max-w-md shadow-hover">
        <CardHeader className="text-center">
          <div className="flex items-center justify-center w-20 h-20 mx-auto mb-4 bg-terracota rounded-lg">
            <span className="text-3xl font-bold text-terracota-foreground">AV Beauty</span>
          </div>
          <CardTitle className="text-2xl">AV Beauty Admin</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="senha" type="password" placeholder="••••••••" value={senha} onChange={e => setSenha(e.target.value)} required disabled={isLoading} />
            </div>

            <Button type="submit" className="w-full bg-terracota hover:bg-terracota/90 text-terracota-foreground" disabled={isLoading}>
